...
public class ConstantsDatabase {
    ...
    public static final String DOCUMENT_TYPE = "typeUser";
    ...
    public static final int CODE_NOTIFICATIONS_DELETE_REQUEST = 4;
    public static final int CODE_NOTIFICATIONS_DELETE_REQUEST_FOR_INFRACTION = 5;
